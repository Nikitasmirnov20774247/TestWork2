...
public class RunApp
{
    ...
    public static void Run()
    {
        ...
        while (true)
        {
            System.out.println("-=Главное меню=-\nЖивотных в наличии: " + Counter.getCounter());
            MainMenu("Main");
                ...
                case 1 -> {
                    try (Counter count = new Counter())
                    {
                        ...
                        if (tmp != null)
                        {
                            ...
                            if (tmp.getName().length() == 0) throw new RuntimeException("Не указано имя животного");
